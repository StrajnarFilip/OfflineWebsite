...
function CacheResourcesOnInstallation(array_of_resources: Array<string>) {
    ...
    self.addEventListener('install', function (event: any) {
        ...
        event.waitUntil(
            caches.open(cacheName).then(function (chosen_cache) {
...
function ActivateCacheFirst() {
    ...
    self.addEventListener('fetch', (fetch_event: any) => {
